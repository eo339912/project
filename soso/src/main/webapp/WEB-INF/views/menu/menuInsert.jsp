...
<div class="row">
	<div class="col">
		<div class="input-group mb-3" id="menuName">
			...
			<input type="text" name="menuName" class="form-control" style="text-align: center;"
...
<div class="row">
	<div class="col">
		<div class="input-group mb-3" id="menuPrice">
			...
			<input type="text" name=""class="form-control" style="text-align: center;"
				placeholder="가격을 입력바래요" aria-label="Username"
	...
	<div class="col">
		<div class="input-group mb-3" id="menuContents">
			...
			<textarea style="width: 600px; text-align: center;" class="DOC_TEXT"
				name="DOC_TEXT" placeholder="200자 이내로 적어주세요.">
</textarea>
...
<div class="col">
	<div class="input-group" id="gear" >
		...
		<button class="btn btn-outline-secondary dropdown-toggle"
			...
			aria-expanded="false">필히 선택해주세요</button>
		<div class="dropdown-menu">
			<a class="dropdown-item" href="#">0</a> <a
				class="dropdown-item" href="#">1</a> 
		</div>
	</div>
</div>
